...
const POOL = {
  ...
  A: [
    ...
    { id: "a18", title: "Promises Mexico will pay for the wall", hint: "Mexico was never asked. Mexico said no.", year: 2015 },
    ...
    { id: "a29", title: "Claims he knows more about taxes than anyone", hint: "Also claimed this about drones, banks, and trade.", year: 2015 },
  ...
  B: [
    ...
    { id: "b13", title: "Pardons Joe Arpaio, convicted of racial profiling", hint: "Before he was even sentenced. Skipped the line.", year: 2017 },
    ...
    { id: "b25", title: "Signs tax cuts for the wealthy on Christmas Eve", hint: "Added $1.9 trillion to the deficit. Merry Christmas.", year: 2017 },
    { id: "b26", title: "Fires Secretary of State Tillerson by tweet", hint: "Tillerson heard about it from a staffer.", year: 2018 },
    { id: "b27", title: "Fires Sessions the morning after midterms", hint: "Sessions had recused himself from the Mueller probe.", year: 2018 },
    { id: "b28", title: "Steve Bannon fired after 7 months", hint: "Bannon: 'I was the only guy who could make it work.'", year: 2017 },
    { id: "b29", title: "Mattis resigns in protest over Syria withdrawal", hint: "His resignation letter was unusually pointed.", year: 2018 },
    ...
    { id: "b36", title: "2,000+ migrant children separated at the border", hint: "Children in cages. Global outrage.", year: 2018 },
  ],
  ...
  C: [
    ...
    { id: "c32", title: "Never officially concedes the 2020 election", hint: "He still hasn't. Formally or otherwise.", year: 2020 },
  ...
  D: [
    ...
    { id: "d8",  title: "Musk reinstates Trump's banned Twitter account", hint: "Trump had been banned after Jan 6", year: 2022 },
    ...
    { id: "d15", title: "Claims the 2020 election was stolen 'no doubt'", hint: "Still does. Every interview. Every rally.", year: 2021 },
    ...
    { id: "d19", title: "Backs Cheney's opponent, she loses by 40 points", hint: "Liz Cheney had voted to impeach him. He did not forget.", year: 2022 },
    { id: "d20", title: "Jan 6 committee recommends criminal prosecution", hint: "Four criminal referrals. Unprecedented for a committee.", year: 2022 },
    { id: "d21", title: "Georgia grand jury report says he lied to them", hint: "The jury recommended charges for 39 people.", year: 2023 },
    ...
    { id: "d24", title: "Retweets QAnon accounts more than 200 times", hint: "His team said he didn't know what QAnon was.", year: 2020 },
    ...
    { id: "d27", title: "Sues CNN for defamation, demands $475 million", hint: "The case was quietly dropped months later.", year: 2022 },
    { id: "d28", title: "Calls 2020 result 'the crime of the century'", hint: "His campaign confirmed the election was not stolen.", year: 2022 },
    ...
    { id: "d35", title: "Claims no courtroom in America is fair to him", hint: "He said this outside multiple courtrooms.", year: 2023 },
  ...
  E: [
    ...
    { id: "e17", title: "Claims he saved TikTok from being banned", hint: "TikTok thanked him. He expected gratitude.", year: 2024 },
    ...
    { id: "e20", title: "Wins primary despite four criminal indictments", hint: "91 charges. More delegates than any Republican before him.", year: 2024 },
    ...
    { id: "e25", title: "Claims he has a secret plan to replace Obamacare", hint: "He's been saying this since 2016. No plan has appeared.", year: 2024 },
    { id: "e26", title: "Promises to 'drill baby drill' on day one", hint: "America was already producing record amounts of oil.", year: 2024 },
    ...
    { id: "e36", title: "Conviction makes no dent in his polling numbers", hint: "Polled immediately after the verdict. Still winning.", year: 2024 },
  ],
  ...
  F: [
    ...
    { id: "f3",  title: "Birthright citizenship order blocked within hours", hint: "14th Amendment. Still applies.", year: 2025 },
    ...
    { id: "f26", title: "Introduces $5M 'gold card' visa for the wealthy", hint: "Pay $5M, skip the line. Green card included.", year: 2025 },
    { id: "f27", title: "Fires head of NSA, director of Cyber Command", hint: "Both in one afternoon. No replacements named.", year: 2025 },
    { id: "f28", title: "Signs executive order banning trans athletes", hint: "Day one. Executive order number four.", year: 2025 },
    ...
    { id: "f33", title: "Declares border a national emergency on day one", hint: "Sent active-duty troops. Called it an invasion.", year: 2025 },
    { id: "f34", title: "Tells Mexico: stop migrants or face 25% tariffs", hint: "Mexico sent 10,000 troops to the border within days.", year: 2025 },
    ...
    { id: "f38", title: "Houthi ceasefire announced on Truth Social", hint: "The Pentagon confirmed it after he posted.", year: 2025 },
    ...
    { id: "f40", title: "Withdraws from the Paris climate agreement again", hint: "First time: 2017. Second time: 2025. Same pen.", year: 2025 },
    { id: "f41", title: "Pulls the US out of the World Health Organization", hint: "Second time doing this. Same executive order, new date.", year: 2025 },
    { id: "f42", title: "Moves to eliminate the Department of Education", hint: "Signs the executive order. Congress would need to agree.", year: 2025 },
    ...
    { id: "f46", title: "Threatens tariffs on the EU over trade imbalance", hint: "Then paused them. Then threatened again.", year: 2025 },
    ...
    { id: "f50", title: "Signs order to ban DEI across federal agencies", hint: "Day one. Executive order number two.", year: 2025 },
    ...
    { id: "f53", title: "Announces trade deal with UK, nothing is signed", hint: "Framework only. Details to follow. Still following.", year: 2025 },
    { id: "f54", title: "Axes environmental reviews by executive order", hint: "To speed up 'energy dominance'. Courts intervened.", year: 2025 },
    { id: "f55", title: "Calls judges 'Trump haters' for ruling against him", hint: "Every judge. Every ruling. Every time.", year: 2025 },
    { id: "f56", title: "Hosts $1M-per-table fundraiser at Mar-a-Lago", hint: "Donors also got a photo. And presumably a Diet Coke.", year: 2025 },
    ...
    { id: "f59", title: "Pardons Silk Road founder Ross Ulbricht", hint: "Promised it at a Libertarian convention. Delivered on day one.", year: 2025 },
    { id: "f60", title: "DOGE fires 200,000+ federal workers in waves", hint: "Probationary employees first. Then everyone else.", year: 2025 },
    { id: "f61", title: "Signs order stripping civil service protections", hint: "Schedule F. Signed, rescinded by Obama, resigned by Trump.", year: 2025 },
    ...
    { id: "f70", title: "Mandates 'patriotic education' in American schools", hint: "Executive order. Teachers were given updated guidelines.", year: 2025 },
    { id: "f71", title: "Consults Elon, Bezos, Tim Cook on tariff policy", hint: "Invited them all to Mar-a-Lago. They came.", year: 2025 },
    { id: "f72", title: "Announces 'Golden Dome' missile defense plan", hint: "Estimated cost: $175 billion. Canada was not included.", year: 2025 },
  ],
